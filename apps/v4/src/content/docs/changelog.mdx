...
## June 2025 - Phone Input

We've added a new `<PhoneInput />` component, built on top of [react-phone-number-input](https://github.com/catamphetamine/react-phone-number-input). This component provides a phone number input field with country selection and formatting.

<ComponentPreview name="phone-input-demo" />

[Read the docs](/docs/primitives/phone-input)
