...
const kbdVariants = cva(
  "pointer-events-none inline-flex select-none items-center gap-1 rounded-md px-1.5 py-0.5 font-mono text-[10px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
