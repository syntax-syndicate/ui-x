...
component: true
links:
  doc: https://github.com/junwen-k/use-ask
---
...
```bash
npx cross-env REGISTRY_URL=https://ui-x.junwen-k.dev/r npx shadcn@latest add confirmer
```
...
<ComponentPreview name="confirmer-safe" />
