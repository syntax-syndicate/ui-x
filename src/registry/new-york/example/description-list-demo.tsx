  ...
  return (
    <DescriptionList>
      <DescriptionGroup>
        ...
        <DescriptionDetail>
          <span className="inline-flex items-center rounded-md border bg-green-50 px-2.5 py-0.5 text-xs font-semibold text-green-700 ring-green-600/20 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
            Published
          </span>
        </DescriptionDetail>
      </DescriptionGroup>
