...
>(({ title, description, className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "group flex min-w-64 cursor-default items-stretch overflow-hidden rounded-xl border bg-card text-card-foreground shadow-sm transition-shadow focus-within:outline-none focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 aria-disabled:pointer-events-none aria-disabled:opacity-50 aria-pressed:z-10 aria-pressed:shadow-lg",
      className
    )}
    {...props}
  >
